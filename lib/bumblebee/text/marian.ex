defmodule Bumblebee.Text.Marian do
  ...
  options =
    [
      ...
      ) ++ Shared.generation_options(forced_bos_token_id: 0, forced_eos_token_id: 0)
  ...
  ## Architectures
    ...
    * `:for_causal_language_modeling` - Marian with a language modeling
  ...
  defp position_embedding(position_ids, spec, opts) do
    ...
    position_ids
    |> Axon.embedding(spec.max_positions, spec.hidden_size, name: name)
  end
