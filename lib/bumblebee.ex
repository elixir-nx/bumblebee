defmodule Bumblebee do
  ...
  @transformers_class_to_model %{
    ...
    "Gemma4TextModel" => {Bumblebee.Text.Gemma4Text, :base},
    "Gemma4ForCausalLM" => {Bumblebee.Text.Gemma4Text, :for_causal_language_modeling},
    ...
    "DeepseekV4Model" => {Bumblebee.Text.DeepseekV4, :base},
    "DeepseekV4ForCausalLM" => {Bumblebee.Text.DeepseekV4, :for_causal_language_modeling},
    "DeepseekV32Model" => {Bumblebee.Text.DeepseekV32, :base},
    "DeepseekV32ForCausalLM" => {Bumblebee.Text.DeepseekV32, :for_causal_language_modeling},
    "DeepseekV32ForSequenceClassification" =>
      {Bumblebee.Text.DeepseekV32, :for_sequence_classification},
    "DeepseekV3Model" => {Bumblebee.Text.DeepseekV3, :base},
    "DeepseekV3ForCausalLM" => {Bumblebee.Text.DeepseekV3, :for_causal_language_modeling},
    "DeepseekV3ForSequenceClassification" =>
      {Bumblebee.Text.DeepseekV3, :for_sequence_classification},
    # Kimi K2 checkpoints use the DeepSeek V3 architecture, while Kimi K2.5
    # is a multimodal model with a DeepSeek V3 text tower
    "Kimi_K25ForConditionalGeneration" =>
      {Bumblebee.Text.DeepseekV3, :for_causal_language_modeling},
    "KimiK25ForConditionalGeneration" =>
      {Bumblebee.Text.DeepseekV3, :for_causal_language_modeling},
    "GlmMoeDsaModel" => {Bumblebee.Text.GlmMoeDsa, :base},
    "GlmMoeDsaForCausalLM" => {Bumblebee.Text.GlmMoeDsa, :for_causal_language_modeling},
    "MuseGlimmerTextModel" => {Bumblebee.Text.MuseGlimmerText, :base},
    "MuseGlimmerForConditionalGeneration" =>
      {Bumblebee.Text.MuseGlimmerText, :for_causal_language_modeling},
    "InklingTextModel" => {Bumblebee.Text.InklingText, :base},
    "InklingForCausalLM" => {Bumblebee.Text.InklingText, :for_causal_language_modeling},
    "InklingForConditionalGeneration" =>
      {Bumblebee.Text.InklingText, :for_causal_language_modeling},
    "GptOssModel" => {Bumblebee.Text.GptOss, :base},
    "GptOssForCausalLM" => {Bumblebee.Text.GptOss, :for_causal_language_modeling},
    "GptOssForSequenceClassification" => {Bumblebee.Text.GptOss, :for_sequence_classification},
    ...
    "LagunaModel" => {Bumblebee.Text.Laguna, :base},
    "LagunaForCausalLM" => {Bumblebee.Text.Laguna, :for_causal_language_modeling},
    "NemotronHModel" => {Bumblebee.Text.NemotronH, :base},
    "NemotronHForCausalLM" => {Bumblebee.Text.NemotronH, :for_causal_language_modeling},
    "MiMoV2FlashModel" => {Bumblebee.Text.MiMoV2Flash, :base},
    "MiMoV2FlashForCausalLM" => {Bumblebee.Text.MiMoV2Flash, :for_causal_language_modeling},
    "Lfm2Model" => {Bumblebee.Text.Lfm2, :base},
    "Lfm2ForCausalLM" => {Bumblebee.Text.Lfm2, :for_causal_language_modeling},
    "Lfm2ForSequenceClassification" => {Bumblebee.Text.Lfm2, :for_sequence_classification},
    ...
    "Qwen3MoeModel" => {Bumblebee.Text.Qwen3Moe, :base},
    "Qwen3MoeForCausalLM" => {Bumblebee.Text.Qwen3Moe, :for_causal_language_modeling},
    "Qwen3MoeForSequenceClassification" =>
      {Bumblebee.Text.Qwen3Moe, :for_sequence_classification},
