defmodule Bumblebee do
  ...
  @transformers_class_to_model %{
    ...
    "MarianMTModel" => {Bumblebee.Text.Marian, :for_causal_language_modeling},
    "MarianForCausalLM" => {Bumblebee.Text.Marian, :for_causal_language_modeling},
  ...
  @model_type_to_tokenizer %{
    ...
    "marian" => Bumblebee.Text.MarianTokenizer,
